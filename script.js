...
'exp1.item1': 'Gestão de comunicação com clientes e fornecedores em ambiente remoto',
            ...
            'exp1.item3': 'Coordenação de fluxo de trabalho e acompanhamento de tarefas com Trello para garantir cumprimento de prazos',
            'exp1.item4': 'Pesquisa e organização de informações estratégicas para tomada de decisões',
            'exp1.item5': 'Suporte administrativo remoto para otimização de operações internas',
            'exp1.item6': 'Coordenação de horários, reservas e comunicação digital com clientes',
            ...
            'exp2.item3': 'Identificação de necessidades e soluções personalizadas para o cliente',
            ...
            'exp2.item7': 'Elaboração e envio de relatórios de atividades através do Telegram',
            ...
            'exp3.item2': 'Resolução eficiente de dúvidas e problemas dos clientes',
            'exp3.item3': 'Suporte a operações de vendas e processos administrativos',
            'exp3.item4': 'Comunicação e colaboração com a equipa através do Workplace by Facebook',
'exp3.item5': 'Suporte em tarefas administrativas e organização de processos internos',
            'exp4.title': 'Atendente e Vendedor',
            'exp4.period': '01/04/2026 – 01/05/2026 | Remoto',
            'exp4.item1': 'Atendimento ao cliente 100% online via WhatsApp e Instagram',
            'exp4.item2': 'Apoio na escolha de jogos, games e equipamentos',
            'exp4.item3': 'Gestão de contas digitais internacionais e ativações',
            'exp4.item4': 'Controlo de pedidos e organização de vendas',
            'exp4.item5': 'Comercialização de equipamentos de alto valor e fecho de vendas',
...
'tools.project': 'Gestão de Projetos',
            ...
            'lang.english': 'Inglês',
            'lang.native': 'Nativo',
'lang.basic': 'Básico - Atualmente em Aprimoramento',
            'lang.basicImproving': 'Básico - Atualmente em Aprimoramento',
            'lang.improving': 'em aprimoramento',
'contact.title': 'Contato',
            'contact.info': 'Informações',
            'contact.availability.title': 'Disponibilidade',
            'contact.availability': 'Seg-Sex (9h-17h) - Luanda GMT+1',
...
'skill.consultative_sales': 'Vendas Consultivas',
            'skill.product_knowledge': 'Conhecimento em Produtos Digitais e Gaming',
            'skill.nutritional_supplements': 'Suplementos Nutricionais',
            'skill.sales_reporting': 'Relatórios de Vendas',
            'skill.sales_analysis': 'Atendimento ao Cliente em Canais Online',
...
'exp3.item5': 'Support in administrative tasks and organization of internal processes',
            'exp4.title': 'Sales Assistant & Seller',
            'exp4.period': '01/04/2026 – 01/05/2026 | Remote',
            'exp4.item1': '100% online customer service via WhatsApp and Instagram',
            'exp4.item2': 'Product knowledge in digital products, games and gaming equipment',
            'exp4.item3': 'Management of international digital accounts and activations',
            'exp4.item4': 'Order control and sales organization',
            'exp4.item5': 'Sales of high-value equipment and closing sales',
            'skills.title': 'Skills',
            ...
            'lang.native': 'Native',
'lang.basic': 'Basic - Currently Improving',
            'lang.basicImproving': 'Basic - Currently Improving',
            'lang.improving': 'improving',
            'contact.title': 'Contact',
            'contact.info': 'Contact Info',
            'contact.availability.title': 'Availability',
'contact.availability': 'Mon-Fri (9am-5pm) - Luanda GMT+1',
...
'skill.consultative_sales': 'Consultative Sales',
            'skill.product_knowledge': 'Digital Products & Gaming Knowledge',
            'skill.nutritional_supplements': 'Nutritional Supplements',
            'skill.sales_reporting': 'Sales Reporting',
            'skill.sales_analysis': 'Customer Service via Online Channels',
